...
def main(argv=None):
    ...
    runner.add_argument("--tune-endpoints", action="store_true", help="Use cached Optuna endpoint parameters, searching when needed; Bézier settings stay fixed.")
    runner.add_argument("--tuning-trials", type=int, default=20, help="Total Optuna trial budget; increasing it resumes the cached study.")
    runner.add_argument("--tuning-seed", type=int, default=42)
    runner.add_argument("--tuning-cache", default="runs/optuna-cache", help="Persistent study/cache directory, independent of the run output.")
