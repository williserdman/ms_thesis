...
def get_data_load(args, split_index=1, split_seed=42):
    dataset = DataLoader(args.dataset, split_index=split_index, split_seed=split_seed)
    data = dataset[0]
    ...
    args.use_external_splits = bool(getattr(dataset, "uses_external_splits", False))
